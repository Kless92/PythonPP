...
def townHall(char):
    ...
    if townHallFirst == True:
        ...
        print("The large man notice the",char,", given a suprice and then a excited look.")
...
def generalStore(char):
    ...
    if generalStoreFirst == True:
        print("Inside the",char,"notices vary little items in this store.\nThis store must have had better days.")
    ...
    while True:
        ...
        if a == "1" or a.lower() == "buy" or a.lower() == "supplies" or a.lower == "buy supplies" or a.lower == "buysupplies":
            ...
            if char == "Theif":
                ...
                print("I ever see the monster myself,\nbut I think the Inn Keep might know.")
    ...
    while True:
        ...
        if a == "1" or a.lower() == "buy" or a.lower() == "supplies" or a.lower == "buy supplies" or a.lower == "buysupplies":
            if char == "Theif":
                ...
                print("I would think a",char,"wouldn't benifit from the arcan arts.")
...
def innKeeper(char):
    ...
    while True:
        ...
        if a == "1" or a.lower() == "buy" or a.lower() == "supplies" or a.lower == "buy supplies" or a.lower == "buysupplies":
            ...
            if char == "Theif":
                print("In fact no one in this town would ever does business with a",char,".")
            ...
            if innRumor == True:
                print("I know the rumors that I seen the monster but no I havent.\nHow the huntsman has, he told me himself.")
                input("Hes not here now but he is out in the forest,\nwest from the cross roads north of town")
            else:
        ...
        if a == "1" or a.lower() == "buy" or a.lower() == "supplies" or a.lower == "buy supplies" or a.lower == "buysupplies":
            ...
            if char == "Theif":
                if theifInfo == True:
                    ...
                    print("Its a Demon Lord, go to the marshs, find the stomp, get the weapon and kill it.")
                    input("Got it?")
                theifInfo = False
            else:
